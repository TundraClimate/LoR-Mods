...
namespace DebugUtil
{
    /// <summary>A scheduler in battle phase</summary>
    public class InBattleScheduler : Singleton<InBattleScheduler>
    {
        /// <summary>Apply harmony patches</summary>
        public InBattleScheduler()
        {
            Harmony harmony = new Harmony("DebugUtil.Schedule");
        ...
        /// <summary>Add schedule for <paramref name="time"/></summary>
        /// <param name="time">Schedule inserting timing</param>
        /// <param name="schedule">Appends schedule for all time</param>
        ...
        /// <summary>A timing of schedule</summary>
