...
public class ModResource
{
    ...
    private static void LoadAdditionalXmls()
    {
        ...
        Harmony harmony = new Harmony(PowerfulEstherMOD.packageId + ".Resource");
    ...
    private static string _asmPath = Path.GetDirectoryName(typeof(PowerfulEstherMOD).Assembly.Location);
