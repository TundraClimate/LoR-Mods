...
public class BattleUnitBuf_TheSlash : PrescriptBuf
{
    ...
    public override bool IsIndexMarkNeeds(BattleDiceCardModel model)
    {
        ...
        {
            LorId[] pids = new[] { new LorId(PowerfulEstherMOD.packageId, 16) };
        ...
        {
            if (beh.Type == BehaviourType.Atk && beh.Detail == BehaviourDetail.Slash)
            {
                count++;
            }
        }
