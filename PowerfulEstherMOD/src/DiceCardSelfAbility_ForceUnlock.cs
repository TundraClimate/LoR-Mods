public class DiceCardSelfAbility_ForceUnlock : DiceCardSelfAbilityBase
{
    public static string Desc = "幕の終了時、指令の加護が3未満なら3まで増加。増加した値だけカルマを得る";

    public override void OnUseCard()
    {
        base.owner.bufListDetail.AddBuf(new BattleUnitBuf_ForceUnlockLazy());
    }

    private class BattleUnitBuf_ForceUnlockLazy : BattleUnitBuf
    {
